...
function reinicio(){
	...
	a = g;
	dt = 0.016683;
	document.getElementById("imgnave").src = {nave};
}
//función de pausa//
function Pausa(){
	stop();
...
function gameOver(){
	document.getElementById("imgnave").src = {explosion};
	var r = window.confirm("La misión ha sido un fracaso. Todos los tripulantes están muertos. ¿Quieres volver a empezar?");
	if (r == true){
		reinicio();
		start();
	} 
